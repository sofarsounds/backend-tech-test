...
What we would like is to see some code that takes this API route and imports it into a databse which would allow us to search via song name, artist or city.
...
Then upload to somewhere like github or bitbucket (has free private repos) and share with us, or zip and send to us.
